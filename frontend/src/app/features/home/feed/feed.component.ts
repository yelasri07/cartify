...
export class FeedComponent implements OnDestroy {
  ...
  handleChange() {
    ...
    this.productService.loadProducts(undefined, this.searchIpt.value ?? "", this.sortBy.value ?? "id")
  }

  private search(value: any) {
    this.productService.resetPage()
    this.productService.resetProducts()
    this.productService.loadProducts(undefined, value, this.sortBy.value ?? "id")
  }
}
